...
center_m = [0.47736860739730819, 0.52876976606111747]
center_c = [[ 0.0063349 ,  0.00090696],[ 0.00090696,  0.00679445]]
# for i in gmm_obj['center']['F_POS']:
# 	print i,gmm_obj['center']['F_POS'][i]
...
for loc in locations:
	sorted_x = sorted(all_valid_hypotheses['F_POS'][loc].items(), key=operator.itemgetter(1))
	print sorted_x
#

	img = np.zeros(shape=(300,300,3),dtype=np.uint8)+255
	cv2.rectangle(img,(50,50),(250,250),(0,0,0),3)
	cv2.imwrite('/home/omari/Dropbox/Reports/AAAI16/Muhannad/pics/'+loc+'.png',img)
