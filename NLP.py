...
toy_pcfg3 = PCFG.fromstring("""
    S -> motion_TETV TE_TV [0.851852]
    S -> _S [0.148148]
    _location -> location [1.0]
    TETV_connect -> in the [0.45]
    TETV_connect -> to the [0.3]
    TETV_connect -> on the [0.15]
    TETV_connect -> on [0.1]
    _in_the_top -> in the top [1.0]
    TV -> _location corner [0.8]
    TV -> _location left corner [0.12]
    TV -> it _location left corner [0.04]
    TV -> it in the _location corner [0.04]
    _S -> _S _S [0.5]
    _S -> motion_TV TV [0.25]
    _S -> motion_TE TE [0.25]
    TE_TV -> TE TETV_connect TV [0.869565]
    TE_TV -> TE TV [0.130435]
    _shape -> shape [1.0]
    ...
    the -> 'the' [1.0]
    left -> 'left' [1.0]
    motion_TE -> 'put' [0.504105]
    motion_TE -> 'take' [0.495895]
    color -> 'green' [1.0]
    motion_TETV -> 'move' [0.917805]
    motion_TETV -> 'place' [0.082195]
    shape -> 'prism' [0.11156]
    shape -> 'pyramid' [0.88844]
    location -> _top_left [0.816423]
    location -> _in_the_top [0.183577]
    motion_TV -> 'put' [0.504105]
    motion_TV -> 'take' [0.495895]
    """)
