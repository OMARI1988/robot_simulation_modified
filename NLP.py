...
toy_pcfg3 = PCFG.fromstring("""
    ...
    TE_TV -> TE TETV_connect TV [0.711538]
    TE_TV -> TE TV [0.288462]
    _shape -> shape [1.0]
    _entity -> color shape [0.983051]
    _entity -> shape color [0.0169492]
    _left_back -> left back [1.0]
    _on_top -> on top [1.0]
    TV -> _direction _entity [0.346154]
    TV -> _location corner [0.269231]
    TV -> _direction the _entity [0.25]
    TV -> _direction of the _entity [0.0769231]
    TV -> _direction of _entity [0.0384615]
    TV -> _direction top of the _entity [0.0192308]
    _direction -> direction [1.0]
    _of_the -> of the [1.0]
    TE -> the _shape [0.423077]
    TE -> the _entity [0.384615]
    TE -> _color [0.173077]
    TE -> the green _entity [0.0192308]
    _top_of_the -> top of the [1.0]
    TETV_connect -> in the [0.162162]
    TETV_connect -> on top [0.162162]
    TETV_connect -> on [0.162162]
    TETV_connect -> to [0.108108]
    TETV_connect -> top [0.108108]
    TETV_connect -> to the [0.0810811]
    TETV_connect -> on the [0.0810811]
    TETV_connect -> to top [0.0810811]
    TETV_connect -> the [0.0540541]
    ...
    over -> 'over' [1.0]
    left -> 'left' [1.0]
    color -> _to_top [0.012025]
    color -> 'green' [0.295419]
    color -> 'red' [0.568176]
    color -> _the_prism_on [0.124379]
    shape -> 'cube' [0.32274]
    shape -> 'prism' [0.307792]
    shape -> 'pyramid' [0.220581]
    shape -> 'block' [0.148886]
    direction -> 'on' [0.105397]
    direction -> _on_top [0.0271909]
    direction -> _over_the [0.0270652]
    direction -> 'of' [0.232694]
    direction -> 'top' [0.130072]
    direction -> _of_the [0.128703]
    direction -> _on_top_of [0.0272292]
    direction -> _top_of_the [0.0816126]
    direction -> _on_the [0.0771368]
    direction -> _top_of [0.136047]
    direction -> 'over' [0.0268522]
    location -> _left_back [0.355933]
    location -> _bottom_left [0.644067]
    motion_TETV -> 'put' [0.0350849]
    motion_TETV -> 'move' [0.910279]
    motion_TETV -> 'place' [0.0546363]
    """)
