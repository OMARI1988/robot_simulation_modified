...
#--------------------------------------------------------------------------------------------------------#
    def _read_grammar(self, scene, valid_scenes):
        ...
        if g != []:
            ...
            grammar         = pickle.load( open( "/home/omari/Dropbox/robot_modified/AR/pickle/grammar_"+sc+".p", "rb" ) )
            self.T          = grammar[0]
            self.N          = grammar[1]
        ...
        if g > 0:
            ...
            analysis                    = pickle.load( open( "/home/omari/Dropbox/robot_modified/AR/pickle/analysis_"+sc+".p", "rb" ) )
    ...
    def _build_motion_hyp(self):
        for s in self.phrases:
            for word in self.phrases[s]:
                not_ok = 1
                for w in word.split(' '):
                    for b_word in ['اختيار','مكان','وضع','امسك','ضع ارضا','ضع','تغير','إسقاط','أخذ','إزالة','خطوة','أنقل','حركها','حرك','ضع','']:
    ...
    def _build_PCFG(self):
        ...
        if self.dropbox:
            pickle.dump( [self.T, self.N, self.no_match], open( "/home/omari/Dropbox/robot_modified/AR/pickle/grammar_"+sc+".p", "wb" ) )
            file2 = open("/home/omari/Dropbox/robot_modified/AR/grammar/grammar_"+sc+".txt", "w")
            file3 = open("/home/omari/Dropbox/robot_modified/AR/hypotheses/grammar.txt", "w")
    ...
    def _analysis(self):
        ...
        # file1 = open("/home/omari/Datasets/robot_modified/AR/analysis/analysis_"+sc+".txt", "w")
        # file1.write(analysis)
        # file1.close()



        # file1 = open("/home/omari/Datasets/robot_modified/AR/hypotheses/all_scenes.txt", "w")
        # scenes = sorted(self.correct_commands.keys())
        # for s in scenes:
        #     file1.write(str(s)+'\n')
        # file1.close()
        #
        # file1 = open("/home/omari/Datasets/robot_modified/AR/hypotheses/matched_commands.txt", "w")
        # scenes = sorted(self.correct_commands.keys())
        # for s in scenes:
        ...
        # file1.close()
        #
        # file1 = open("/home/omari/Datasets/robot_modified/AR/hypotheses/failed_commands.txt", "w")
        ...
        # file1 = open("/home/omari/Datasets/robot_modified/AR/hypotheses/correct_hyp.txt", "w")
        ...
        # pickle.dump( [self.correct_commands, self.wrong_commands, self.all_valid_hypotheses, self.scenes_so_far, self.commands_so_far], open( "/home/omari/Datasets/robot_modified/AR/pickle/analysis_"+sc+".p", "wb" ) )
        if self.dropbox:
            pickle.dump( [self.correct_commands, self.wrong_commands, self.all_valid_hypotheses, self.scenes_so_far, self.commands_so_far], open( "/home/omari/Dropbox/robot_modified/AR/pickle/analysis_"+sc+".p", "wb" ) )
            file2 = open("/home/omari/Dropbox/robot_modified/AR/analysis/analysis_"+sc+".txt", "w")
            file2.write(analysis)
            file2.close()

            file2 = open("/home/omari/Dropbox/robot_modified/AR/hypotheses/all_scenes.txt", "w")
            scenes = sorted(self.correct_commands.keys())
            for s in scenes:
                file2.write(str(s)+'\n')
            file2.close()

            file2 = open("/home/omari/Dropbox/robot_modified/AR/hypotheses/matched_commands.txt", "w")
            scenes = sorted(self.correct_commands.keys())
            for s in scenes:
                for c in self.correct_commands[s]:
                    file2.write(c+'\n')
            ...
            file2 = open("/home/omari/Dropbox/robot_modified/AR/hypotheses/failed_commands.txt", "w")
            scenes = sorted(self.wrong_commands.keys())
            for s in scenes:
                for c in self.wrong_commands[s]:
                    file2.write(c+'\n')
            ...
            file2 = open("/home/omari/Dropbox/robot_modified/AR/hypotheses/correct_hyp.txt", "w")
            for feature in self.all_valid_hypotheses:
                x = self.all_valid_hypotheses[feature]
                for word in self.all_valid_hypotheses[feature]:
                    x = self.all_valid_hypotheses[feature][word]
